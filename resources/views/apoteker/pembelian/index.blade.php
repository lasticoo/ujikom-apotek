<x-apoteker-layout>
    <div class="d-flex align-items-center justify-content-between mb-4">
        <div>
            ...
            <h2 class="page-title mb-0">Daftar Pembelian / Restok Obat</h2>
        </div>
        <div>
            <a href="{{ route('apoteker.pembelian.create') }}" class="btn btn-primary">
        ...
        <div class="card-body py-2">
            <form method="GET" class="row g-2 align-items-end">
                ...
                <div class="col-auto">
                    ...
                    <a href="{{ route('apoteker.pembelian.index') }}" class="btn btn-sm btn-outline-secondary ms-1">Reset</a>
                </div>
            </form>
        </div>
    </div>
                    ...
                    <tbody>
                        @forelse($pembelians as $p)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('apoteker.pembelian.show', $p->nota) }}"
